...
export default function Calendar({ data }: { data: Event[] }) {
  // GET TODAY'S DATE
  ...
  let selectedDayMeetings = meetings.filter(
    (meeting) =>
      isWithinEventRange(
        ...
        parseISO(meeting.endDatetime as string),
  ...
  return (
    <>
      <div className="mb-20 md:grid md:grid-cols-2 md:divide-x md:divide-gray-400/30">
        {/* DAYS OF THE WEEK */}
